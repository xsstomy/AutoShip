...
const BatchStatusConfirmDialog: React.FC<BatchStatusConfirmDialogProps> = ({
  isOpen,
  onClose,
  onConfirm,
  selectedCount,
  ...
  const isActivating = isActive // 从下架状态变为上架状态
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4">
        ...
        <div className="px-6 py-4">
          <p className="text-gray-600 mb-3">
            确定要{action}选中的 <span className="font-semibold text-gray-900">{selectedCount}</span> 个商品吗？
          </p>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm text-gray-800">
                  <strong>操作影响：</strong>此操作将同时更新 {selectedCount} 个商品的状态。
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm text-amber-800">
                    <strong>注意：</strong>下架后这些商品将不在前台显示，客户将无法购买。
                  </p>
                </div>
              </div>
            </div>
...
export default BatchStatusConfirmDialog